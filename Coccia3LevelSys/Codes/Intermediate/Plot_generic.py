...
Output_dir = f"../../Results/Plot/Populations/{int(theta_deg)}"
...
save_fig(fig_jumps, f'Total_Jumps_Theta_{int(theta_deg)}')
...
save_fig(fig01, f'Comparison_3pop_Theta_{int(theta_deg)}') 
...
save_fig(fig02, f'Single_Traj_vs_Lindblad_Theta_{int(theta_deg)}')
...
save_fig(fig03, f'Many_Traj_vs_Average_Theta_{int(theta_deg)}')
...
save_fig(fig04, f'Coherences_Theta_{int(theta_deg)}')
...
if len(no_jump_indices) > 0:
    ...
    save_fig(fig_pop, f'NO_JUMPS_Populations_Theta_{int(theta_deg)}')
    ...
    save_fig(fig_coh, f'NO_JUMPS_Coherences_Theta_{int(theta_deg)}')
