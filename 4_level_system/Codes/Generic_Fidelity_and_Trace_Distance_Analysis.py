...
Output_dir = f"../Results/Plot/Metrics/{phi_str}"
...
metrics_filename = f"Angle_{phi_str}_F_TD_Metrics_dt{dt_str}_Ntraj{N_traj}.npz"
...
filename_avg = f"Angle_{phi_str}_Global_Convergence_Metrics_dt{dt_str}"
...
filename_single = f"Angle_{phi_str}_Single_Traj_Comparison_dt{dt_str}"
