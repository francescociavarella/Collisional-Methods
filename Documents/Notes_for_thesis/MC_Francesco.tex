...
.
	  ...
	  \begin{align}
	  	\mathcal{M}_0 \mathcal{M}_{0}^{\dagger} = \left[g_0^2 \cos^2{\left(c_j \Delta t \right)} + \left(g_0 g_z + g_1 g_x \right)^2 \sin^2{\left(c_j \Delta t \right)} \right]  \mathbb{I}^{j} \notag \\
	  	\mathcal{M}_1 \mathcal{M}_{1}^{\dagger} = \left[g_1^2 \cos^2{\left(c_j \Delta t \right)} + \left(g_0 g_x - g_1 g_z \right)^2 \sin^2{\left(c_j \Delta t \right)} \right]  \mathbb{I}^{j} \notag
	  \end{align}
	  Calculation of those quantities related to the wvefunction Modification Intensity:
	  \begin{align}
	  	\left| \bra{\Psi_{S}}\mathcal{M}_0 \ket{\Psi_{S}} \right|^2 = g_0^2 \cos^2{\left(c_j \Delta t \right)} + \left(g_0 g_z + g_1 g_x \right)^2 \sin^2{\left(c_j \Delta t \right)} \left| \bra{\Psi_{S}}\sigma_{z}^{j}\ket{\Psi_{S}} \right|^2 \label{eq:exp_square_M0} \\
	  	\left| \bra{\Psi_{S}}\mathcal{M}_1 \ket{\Psi_{S}} \right|^2 = g_1^2 \cos^2{\left(c_j \Delta t \right)} + \left(g_0 g_x - g_1 g_z \right)^2 \sin^2{\left(c_j \Delta t \right)} \left|\bra{\Psi_{S}}\sigma_{z}^{j}\ket{\Psi_{S}}\right|^2 \label{eq:exp_square_M1} 
	  \end{align}
