...
.
	  ...
	  \end{equation} 
	   ...
	   \graphicspath{ {/home/francesco/Collisional_Methods/Results/Plot/} }
	   \begin{figure}[H]
	   	\centering
	  ...
	  \begin{align}
	  	\left| \braket{\Psi_{S}^{PRE} | \Psi_{S}^{POST}}_{\mathcal{M}_{0}} \right|^2 = \left| \bra{\Psi_{S}}\mathcal{M}_0 \ket{\Psi_{S}} \right|^2 &= g_0^2 \cos^2{\left(c_j \Delta t \right)} + g_1^2 \sin^2{\left(c_j \Delta t \right)} \left| \braket{\sigma_{z}^{j}} \right|^2 \label{eq:fidelity_M0} \\
	  	\left| \braket{\Psi_{S}^{PRE} | \Psi_{S}^{POST}}_{\mathcal{M}_{1}} \right|^2 = \left| \bra{\Psi_{S}}\mathcal{M}_1 \ket{\Psi_{S}} \right|^2 &= g_1^2 \cos^2{\left(c_j \Delta t \right)} + g_0^2 \sin^2{\left(c_j \Delta t \right)} \left| \braket{\sigma_{z}^{j}} \right|^2 \label{eq:fidelity_M1}
	  \end{align}
	  where 
	  \begin{equation*}
	  ...
	  So we need to evaluate this for different values os expectation value of $ \left| \braket{\sigma_{z}^{j}} \right|^2 $ in different unraveling scheme. For this purpose it might be useful to rephrase Eq.\eqref{eq:fidelity_M0} and Eq.\eqref{eq:fidelity_M0} as follows:
