...
.
	  ...
	  So we need to evaluate this for different values os expectation value of sigma z in different unraveling scheme. it's important to calculate quanto spesso uno stato e quindi un valore del valore di aspettazione di sigma z viene campionato con diversi unravleing scheme (cosa degli istogrammi).
