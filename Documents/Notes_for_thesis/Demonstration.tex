...
.
	  ...
	  It is worth noting that the resulting Master Equation that lead to the Lindblad form with $ \mathcal{L}_k = \sigma_{z} $ describes a Pure Dephasing dynamic, where the Collsional environment destroys the quantum Coherence of the system, without inducing population transfer (energy relaxation).
